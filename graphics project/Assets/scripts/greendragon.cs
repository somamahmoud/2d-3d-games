...
public class greendragon : MonoBehaviour
{
    ...
    {
        if (collision.CompareTag(greendia))
        {
            i += 1;
    ...
    {
        if (collision.gameObject.CompareTag(collid) | collision.gameObject.CompareTag("bluedrag") || collision.gameObject.CompareTag("rock"))
        {
            ground = true;
        }
    }
